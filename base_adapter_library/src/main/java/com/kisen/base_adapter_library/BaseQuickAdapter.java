...
import com.kisen.base_adapter_library.animation.AlphaInAnimation;
import com.kisen.base_adapter_library.animation.BaseAnimation;
import com.kisen.base_adapter_library.animation.ScaleInAnimation;
import com.kisen.base_adapter_library.animation.SlideInBottomAnimation;
import com.kisen.base_adapter_library.animation.SlideInLeftAnimation;
import com.kisen.base_adapter_library.animation.SlideInRightAnimation;
import com.kisen.base_adapter_library.callback.ItemDragAndSwipeCallback;
import com.kisen.base_adapter_library.listener.OnItemDragListener;
import com.kisen.base_adapter_library.listener.OnItemSwipeListener;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RequestLoadingListener mRequestLoadMoreListener;
    @AnimationType
     ...
     */
    @Deprecated
    public void setOnLoadMoreListener(int pageSize, RequestLoadingListener requestLoadMoreListener) {

        setOnLoadMoreListener(requestLoadMoreListener);
    }

    public void setOnLoadMoreListener(RequestLoadingListener requestLoadMoreListener) {
    ...
    /**
     * clear all data without headerViews
     */
    public void clear() {
        int size = mData.size();
        mData.clear();
        notifyItemRangeRemoved(getHeaderViewsCount() - 1, size);
    }
    ...
    /**
     * insert  a item associated with the last position of adapter which front footerView`s position
     *
     * @param item
     */
    ...
    private void addLoadMore(RecyclerView.ViewHolder holder) {
        if (isLoadMore() && !mLoadingMoreEnable) {
            ...
            mRequestLoadMoreListener.onLoad();
        }
    }
